...
\newcommand{\el}[1]{\textcolor{blue}{ZK: #1}}
...
Oh no... \cite{DBLP:conf/soda/PhillipsT18}
...
Selecting $o(1/\eps^2)$ is claimed to be impossible due to \cite{DBLP:conf/focs/DeshpandeR10} and \cite{DBLP:conf/soda/DeshpandeRVW06} and \cite{DBLP:conf/soda/GhashamiP14}.
