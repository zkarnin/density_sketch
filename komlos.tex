...
\begin{proof}
%Using our framework, we need to bound $K_m = \frac{1}{m}\sum_{i=1}^m \sigma_i K(x_i,q)$. 
...
\zk{Not sure where to put this table - also we need to update it if we use it. Either way, beyond this point we can throw away the sections below}
