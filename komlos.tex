...
$$\sum_{i=1}^m \sigma_i K(x_i,y) = \sum_{i=1}^m \sigma_i \ip{\phi(x_i), \phi(y)} =  \ip{ \sum_{i=1}^m \sigma_i \phi(x_i), \phi(y)} \leq $$
$$ \|\phi(y)\| \cdot \left\|  \sum_{i=1}^m \sigma_i \phi(x_i) \right\| \leq \left\|  \sum_{i=1}^m \sigma_i \phi(x_i) \right\| $$
