...
We claim that $K_m$ is the right measure of complexity for bounding the size of coresets (coreset complexity) and for creating mergeable sketches (streaming coreset complexity).
Trivially,  $K_m \le R_m$. 
We show, however, that $K_m(\F) = o(R_m(\F))$ for a wide range of interesting problems in machine learning.
