...
This suffices according to \cite{DBLP:conf/approx/DadushGLN16} and the corresponding convex body $\mathcal K$ being symmetric. TODO Replace with Bansal's paper}
