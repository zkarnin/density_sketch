...
Although the worst case lower bound is $O(1/\eps^2)$ which matches the coreset achieved by sampling, we conjecture that in realistic scenarios, the deterministic algorithm will outperform random sampling as it explicitly takes advantage of negative correlations.
