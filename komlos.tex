...
Rademacher complexity \cite{Bartlett:2003:RGC:944919.944944} is a known method to estimate the generalization ability of an empirical risk minimizer (ERM) of a family of function over a finite set of i.i.d.\ sampled points. 
In that sense, Rademacher complexity is a good measure of sample complexity. 
That is, the generalization of coresets which are chosen i.i.d.\ from the data (or the underlying distribution).
A carefully selected coreset can be better than a uniformly sampled one. 
