...
For any function $f$ with a corresponding Komlos Complexity $K_m = O(c/m)$ there exists a fully-mergeable streaming coreset algorithm of size 
...
\begin{theorem}
For any function $f$ with a corresponding Komlos Complexity of $K_m = O(c/\sqrt{m})$ there exists a fully-mergeable streaming coreset algorithm of size 
